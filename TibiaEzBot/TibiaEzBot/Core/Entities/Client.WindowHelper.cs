    ...
    public partial class Client
    {
        public class WindowHelper
        {
            ...
            public bool ActionStateFreezer {
                ...
                set {
                    Array.Copy(BitConverter.GetBytes((int)Addresses.Client.ActionState), 0, Addresses.Client.ActionStateOriginal, 1, 4);
                    Array.Copy(BitConverter.GetBytes((int)Addresses.Client.ActionState), 0, Addresses.Client.ActionStateFreezed, 2, 4);
                   
                    if (value) {
                        client.Memory.WriteByte((long)Addresses.Client.ActionState, (byte)Constants.ActionState.Using);
